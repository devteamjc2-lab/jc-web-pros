...
function App() {
  ...
  return (
    ...
    // 2. 👇 POORE APP KO BROWSERROUTER SE WRAP KIYA
    <BrowserRouter>
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        {/* 3. 👇 MAIN TAG KE ANDAR ROUTES CONFIGURATION LAGAYI */}
        <main className="app-shell" style={{ flex: '1', padding: '20px 0' }}>
          <Routes>
            {/* Jab URL '/' hoga toh Home page dikhega */}
            <Route path="/" element={<Home />} />
            
            {/* Jab URL '/about' hoga toh About page dikhega */}
            <Route path="/about" element={<About />} />
            
            {/* Jab URL '/contact' hoga toh Contact page dikhega */}
            <Route path="/contact" element={<Contact />} />
              <Route path="/login" element={ <Login />} />
            {/* Jab URL '/chat' hoga toh aapka Chat system dikhega */}
